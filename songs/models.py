...
class Song(models.Model):
    ...
    Each song can have an (optional) external link that will appear next to the song heading as an arrow
    '''
    ...
    external_link = models.URLField(max_length=200, blank=True, default="")
